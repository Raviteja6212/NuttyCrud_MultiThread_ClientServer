...
public class NC_MultiThread_Client1 {
		...
		if(op_value==1) {
			...
			while(chanceforuser!=0) {
				...
				try {				
					...
					String name = "CLIENT_1,0"+","+op_value+","+username+","+password;
		    	  ...
		    	  String cid="",cname="",cemail=""; int cperiod=0; 
	  			  ...
	  			  while(youroption!=5 ) {
					  ...
					  if(youroption==1) {
						  while( continue_.equals("y") ) {
							  try {
								  ...
								  while(c1!=0) {
									  ...
									  System.out.print("\nEnter Customer ID  - ");
									  cid = cinputs.next();
									  sendtoserver.println("CLIENT_1,id_check,"+cid);
								  ...
								  if(goodinput==true && badinput==false) {
									  text = "CLIENT_1,1"+","+cid+","+cname+","+cemail+","+cperiod+",active"+",0";
						  ...
						  String cid_find = cscan.next();
						  sendtoserver.println("CLIENT_1,id_check,"+cid_find);
						  temp = serverResponse.nextLine();
						  if("True".equals(temp)) {
							  String find="CLIENT_1,2,"+cid_find;
							  ...
							  if(choice_.equals("y")) {
								  ...
								  if(correctinput) {
									  update_ = "CLIENT_1,3,"+cid_find+","+update_+","+new_val;
						  ...
						  if("True".equals(temp)) {
							  ...
							  if(choice_.equals("y")) {
								  String delete_ = "CLIENT_1,4,"+cid_find;
